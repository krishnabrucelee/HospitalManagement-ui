ngApp.controller('doctorScheduleCtrl', ['$scope','$http',
	function($scope,$http) {
		...
		$http.get("listDoctorDetails").success(function(data){
			...
			$scope.doctorList.forEach(function(value){
				var obj = {};
				obj['@ID']= value.doctorId;
				obj.ContractID = 0;
				obj.Name = value.doctorEmail;
		...
		$scope.saveAttendance = function(){
			...
			$http.post("saveDoctorSchedule",obj).success(function(data){
