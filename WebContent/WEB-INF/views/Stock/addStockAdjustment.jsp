                ...
                <form role="form">
                    <div class="row">
                        ...
                        <div class="col-sm-offset-2 col-sm-7 text-right">
							<button type="submit" class="btn btn-default">Request Form Note</button>
						</div>
						<div class="col-sm-offset-2 col-sm-7 text-right">
							<button type="submit" data-ng-click="purchaseOrder()" class="btn btn-default">Purchase Order</button>
						</div>
                        </div>
                    </div>
        <div class="row">
