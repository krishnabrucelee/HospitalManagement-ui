...
<body data-ng-controller="stockCtrl">
    ...
    <%@ include file="../Common/sidebar.jsp" %>
      <div class="clear">
        ...
        <h1 class="heading">Medicine Stock Entry </h1>
		...
		<thead>
		<tr><th>Medicine Stock Id</th><th>Item Name</th><th>Batch Id</th><th> PurchaseDate</th><th>Manuf date</th><th>Expiry Date</th><th>Units</th><th>Quantity</th><th>Price</th> <th width="20">Action</th></tr>
		</thead>
		 <tr class="success" data-ng-repeat="stock in StockMedicine">
		 <td>{{stock.stockMedicineId}}</td>
