...
<body ng-controller="bloodCtrl">
    ...
    <div class="clear">
        <div class="right_block">
            ...
            <h1 class="heading">Issue Blood</h1>
            <form class="centered_form" name="addIssueBloodForm" data-ng-submit="saveIssueBlood(addIssueBloodForm, blood)">
               <div class="row">
			  ...
			  <div class="row">
				   <div class="form-group col-md-4">
                        ...
                        <select class="form-control"  data-ng-model="blood.patientName" data-ng-options="patient.patientName for patient in patientList">
			  ...
			  <div class="row">
				  ...
				  <div class="form-group col-md-4">
				    <label>Date of Issue:</label>
                       ...
                       ng-model="blood.issueDate" is-open="isOpen" />
